...
# Date: 2017-04-01
# main01.py: Trying the pygame tiles tutorial from qq.readthedocs.io
...
class Level():
    ...
    def render(self,screen):
        ...
        vicinity_mask_parser.read("constants/vicinity_masks.ini")
        ...
        tile_table_parser.read("constants/tile_table.ini")
